                        ...
                        <li class="dropdown user user-menu">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="user-header bg-light-blue">
                                   <? $im=$this->session->userdata('photopath'); ?>
                                    <img src="<?= base_url()."assets/images/".strtolower($im); ?>" class="img-circle" alt="User Image" />
                                    <p>
...
<!-- Sidebar user panel The user image was not displaying due case issue of folder name hence all converted to lower case as in line 27-28 above -->
                   ...
                   <!-- <li><a href="http://172.16.8.45/pms"><i class="fa fa-book"></i> <span>Help Desk</span></a></li>-->
				    <li><a href="<?php echo site_url().'/mis_dashboard/view_help_document'?>"><i class="fa fa-book"></i> <span>Help Desk</span></a></li>
					<li><a href="https://eoffice.iitism.ac.in/" target="_blank" ><i class="fa fa-book"></i> <span>e-Office</span></a></li>
					<li><a href="https://moodle.iitism.ac.in/" target="_blank" ><i class="fa fa-book"></i> <span>e-Learning</span></a></li>
<?php
					...
					if($unreadCount > 0) {
						...
						foreach($notifications[$key]["unread"] as $row) {
							...
							$ui->callout()
							   ...
							   ->desc($row->description . ' <span class="label label-info pull-right" onclick="window.location=\''.site_url('home/show_notification/'.base64_encode($row->send_date).'/'.base64_encode($row->user_to).'/'.base64_encode($row->auth_id)).'\'">Know More &raquo;</span>')
							   ->uiType("info")
