...
class Employee_menu_model extends CI_Model
{
	...
	function getMenu()
	{
		...
		$menu['emp']["Manage Students"]["Inconsistency Checker"] = site_url('inconsistency_checker');
		$menu['emp']["Employee Report"]["View Employees"]["Details"] = site_url('employee/emp_report');
		...
		$menu['admin_estt_ft']=array();
		$menu['admin_estt_ft']['Employee Details']=array();
		$menu['admin_estt_ft']["Employee Details"]["Validation"]=array();
		$menu['admin_estt_ft']["Employee Details"]["Validation"]["Validate Permanent"]=site_url('employee/validation');
		$menu['admin_estt_ft']["Employee Details"]["Report"]=site_url('employee/emp_report');
		$menu['admin_estt_nft']=array();
		$menu['admin_estt_nft']['Employee Details']=array();
		$menu['admin_estt_nft']["Employee Details"]["Validation"]=array();
		$menu['admin_estt_nft']["Employee Details"]["Validation"]["Validate Permanent"]=site_url('employee/validation');
		$menu['admin_estt_nft']["Employee Details"]["Report"]=site_url('employee/emp_report');
		...
		$menu['deo_estt_nft']=array();
		$menu['deo_estt_nft']['Manage Employees']=array();
		$menu['deo_estt_nft']["Manage Employees"]["Add Employee"]=array();
		$menu['deo_estt_nft']["Manage Employees"]["Add Employee"]["Add Permanent Employee"] = site_url('employee/add');
		$menu['deo_estt_nft']["Manage Employees"]["Add Employee"]["Add Retired Employee"] = site_url('employee/add_retired_emp');
		$menu['deo_estt_nft']["Manage Employees"]["View Employee Details"] = site_url('employee/view/menu/deo_estt_nft');
		$menu['deo_estt_nft']["Manage Employees"]["Edit Employee Details"]=array();
		$menu['deo_estt_nft']["Manage Employees"]["Edit Employee Details"]["Edit Permanent Employee"] = site_url('employee/edit/menu/deo_estt_nft');
		$menu['deo_estt_ft']=array();
		$menu['deo_estt_ft']['Manage Employees']=array();
		$menu['deo_estt_ft']["Manage Employees"]["Add Employee"]=array();
		$menu['deo_estt_ft']["Manage Employees"]["Add Employee"]["Add Permanent Employee"] = site_url('employee/add');
		$menu['deo_estt_ft']["Manage Employees"]["Add Employee"]["Add Retired Employee"] = site_url('employee/add_retired_emp');
		$menu['deo_estt_ft']["Manage Employees"]["View Employee Details"] = site_url('employee/view/menu/deo_estt_ft');
		$menu['deo_estt_ft']["Manage Employees"]["Edit Employee Details"]=array();
		$menu['deo_estt_ft']["Manage Employees"]["Edit Employee Details"]["Edit Permanent Employee"] = site_url('employee/edit/menu/deo_estt_ft');
	    ...
	    // add by govind sahu requirement come on 16-06-2021
		$menu['est_dr']=array();
		$menu['est_dr']['Employee Details']=array();
		$menu['est_dr']["Employee Details"]["Validation"]=array();
		$menu['est_dr']["Employee Details"]["Validation"]["Validate Permanent"]=site_url('employee/validation');
